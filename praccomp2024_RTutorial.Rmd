...
```{r}
ggplot(data = gapminder, mapping = aes(x=gdpPercap, y=lifeExp)) + geom_point(aes(color="darkblue"), alpha=0.25) + scale_x_log10() + geom_smooth(method = lm, color="deeppink", fill="chartreuse") + theme_classic()
```
```{r}
